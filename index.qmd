...
::: {.column-screen .snippet style="background-image:url(https://upload.wikimedia.org/wikipedia/commons/c/c0/Pierre_Bourdieu_%281%29.jpg); background-size: 100vw; height: 200px; background-position: center +40%; background-repeat: no-repeat;"}
:::
